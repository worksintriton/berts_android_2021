...
public class ShowAllChildCategActivity_ViewBinding implements Unbinder {
  private ShowAllChildCategActivity target;

  @UiThread
  public ShowAllChildCategActivity_ViewBinding(ShowAllChildCategActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ShowAllChildCategActivity_ViewBinding(ShowAllChildCategActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ShowAllChildCategActivity target = this.target;
