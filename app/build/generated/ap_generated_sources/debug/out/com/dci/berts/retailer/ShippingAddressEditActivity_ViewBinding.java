...
public class ShippingAddressEditActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ShippingAddressEditActivity_ViewBinding(ShippingAddressEditActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ShippingAddressEditActivity_ViewBinding(ShippingAddressEditActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ShippingAddressEditActivity target = this.target;
