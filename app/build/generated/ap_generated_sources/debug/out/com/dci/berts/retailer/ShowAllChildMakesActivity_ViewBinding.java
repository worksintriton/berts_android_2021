...
public class ShowAllChildMakesActivity_ViewBinding implements Unbinder {
  private ShowAllChildMakesActivity target;

  @UiThread
  public ShowAllChildMakesActivity_ViewBinding(ShowAllChildMakesActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ShowAllChildMakesActivity_ViewBinding(ShowAllChildMakesActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ShowAllChildMakesActivity target = this.target;
