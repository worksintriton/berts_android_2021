...
public class WholeSalerProfileAccountActivity_ViewBinding implements Unbinder {
  private WholeSalerProfileAccountActivity target;

  @UiThread
  public WholeSalerProfileAccountActivity_ViewBinding(WholeSalerProfileAccountActivity target) {
  ...
  @CallSuper
  public void unbind() {
    WholeSalerProfileAccountActivity target = this.target;
