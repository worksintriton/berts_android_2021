...
public class ShowAllChildMakesListActivity_ViewBinding implements Unbinder {
  private ShowAllChildMakesListActivity target;

  @UiThread
  public ShowAllChildMakesListActivity_ViewBinding(ShowAllChildMakesListActivity target) {
  ...
  @CallSuper
  public void unbind() {
    ShowAllChildMakesListActivity target = this.target;
