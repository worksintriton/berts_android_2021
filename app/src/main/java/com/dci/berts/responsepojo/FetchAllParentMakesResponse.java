...
public class FetchAllParentMakesResponse {
    ...
    public static class DataBean {
         ...
         * id : 1
         * name : Honda
         * logo : http://dciinternal.in/dev01/assets/img/make/Honda@2x.png
         * status : 1
         * created_at : 2019-10-11 09:21:05
         */
