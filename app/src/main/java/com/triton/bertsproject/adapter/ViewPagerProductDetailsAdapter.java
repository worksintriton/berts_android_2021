...
public class ViewPagerProductDetailsAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        View itemView = inflater.inflate(R.layout.adapter_slidebanner, view, false);
        ImageView imageView = itemView.findViewById(R.id.img_product_image);
